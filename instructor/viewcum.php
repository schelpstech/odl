...
?>													</h2>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                       ...
                       <h4 style="text-align:center;"><?php echo $term ?> Cumulative Scoresheet for <?php echo $subject. ' in '. $classname ?>.</h4><br>
    ...
    <button class="btn btn-default"><strong><?php echo $score ?></strong></button>
             ...
             <td> 
    <button class="btn btn-default"><strong><?php echo $examscore ?></strong></button>
             </td>
             <td> 
    <button class="btn btn-basic"><strong><?php echo $totalscore ?></strong></button>
             </td>
