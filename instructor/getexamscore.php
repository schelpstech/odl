...
?>
    <div id="cadata" class="data-table-area">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                       ...
                       <h4 style="text-align:center;"><?php echo $term ?> Examination Scoresheet for <?php echo $subject. ' in '. $classname ?>.</h4><br>
       ...
       $status = $row["status"];
            ...
            $count=1;
            $query=$conn->prepare("SELECT *  from lhpresultrecord WHERE subjid = '$sbjid' AND term = '$term'and examscore > 0 ORDER BY rectime DESC");
