...
if(!empty($_GET['id'])) {         
        $noteid = $_GET["id"];
       $viewid = $_SESSION['topicid'];
	   
	   $sql = "SELECT * FROM lhpnote WHERE noteid  = '$noteid'";
...
<head>
    ...
    <title>Edit LessonNote -  LearnAble</title>
...
?>													</h2>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            <h2>Edit Note of Lesson</h2>
                            <p>Use the form below to edit note of lessons.</p>
						<h2>	 <?php
  ...
  ?></h2>
                        ...
                        <br>
						<div class="row">
						<form method="POST" action="updatenote.php" class="form-element-area" id="fupload" enctype="multipart/form-data">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" hidden="yes">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text"   class="form-control" name ="notes" placeholder="Full Name" value= "<?php echo $noteid; ?>">
