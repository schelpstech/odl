...
<head>
    ...
    <title>Continuous Assessment Report - LearnAble</title>
        ...
        <div class="container">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Continuous Assessment Reports
							
						</h2>
                            <p>This table contains all the subjects you can generate learners' continuous Assessment Reports</p>
                        </div>
           ...
           $query->execute();
            ...
            <?php
               ...
               $sql = "SELECT count('questid') FROM `lhpquestion` WHERE sbjid = '$sbjt' AND status = 1 AND term = '$terd'";
            ...
            <tr>
				...
				<td><?php echo $sb ?></td>
               	<td><?php echo $num?> </td>
                	<td>
				   <a href="viewsheet.php?sbj=<?php echo $sbjt?>&term=<?php echo $term?>&classid=<?php echo $cname?>" type="button"  class="btn btn-success" >View Report</a>
				</td>
