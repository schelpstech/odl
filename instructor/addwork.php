...
$('#ddiv').hide();
$('#ldiv').attr('required', '');
$('#ldiv').attr('data-error', 'Question field is required.');
}
...
$('#ddiv').hide();
$('#odiv').attr('required', '');
$('#odiv').attr('data-error', 'Online Question link is required.');
}
...
$('#ldiv').hide();
$('#ddiv').attr('required', '');
$('#ddiv').attr('data-error', 'Question Document is required.');
}
else {
...
?>													</h2>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            <h2>Add Assessment to this Topic</h2>
                            <p>Use the form below to add assessment to the topics in your scheme of work.</p>
						<h2>	 <?php
  ...
  ?></h2>
                        ...
                        <br>
						<div class="row">
						<form method="POST" action="createquestion.php" class="form-element-area" id="fupload" enctype="multipart/form-data">
...
?>
                        	 ...
                        	 <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="date" class="form-control" name="due" min ="<?php echo date("Y-m-d");?>" required="yes">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="number" class="form-control" name="grade" min="1" required="yes">
                                    </div>
                                </div>
                            </div>
                            
                     <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
                                 <label> Select Assessment Question Type: </label>
								<div class="form-group ic-cmp-int">
                                ...
                                <option value="none">Select Assessment Question Type</option>            
                                <option value="text">Type in Question</option>
                                 <option value="file">Question Document Upload</option>
								...
								<div class="form-group ic-cmp-int">
									...
									<div class="form-ic-cmp">
									 ...
									 <div class="cmp-int-box mg-t-20">
                                      ...
                                      <textarea   name="lesson"  placeholder="Enter your note here" rows="10" id="editor2"  style="background-color:white; border: 1px solid #ccc;"></textarea>
                             ...
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: none" id="ddiv">
                                 <label> Upload Question Document - PDF Only </label>
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="file" accept=".pdf" class="form-control" name="document" id="document" placeholder="Select question document - pdf file only " >
                             ...
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: none" id="odiv">
                                 <label> Enter link to the Online Assessment </label>
								<div class="form-group ic-cmp-int">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                       <input type="submit" class="form-control" name="createquestion" value="Add Question to This Topic "/> 
                                    </div>
                                </div>
                            </div>
	...
	<script>
     CKEDITOR.replace('editor2', {
      ...
      editorplaceholder: 'Type Your Questions Here...'
    });
  </script>
	<!-- Breadcomb area End-->
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>View Questions for the topic 
                            <?php
foreach ($book as $booked) {
    ?>
...
?>
                            ...
                            <p>This table contains all the questions you have added to this topic </p>
                        </div>
		...
		$lname = $_SESSION['stnamed'];
            ...
            $count=1;
            $query=$conn->prepare("SELECT * from lhpquestion  WHERE (topicid = '$viewid' AND staffid = '$lname' AND status = 1) ORDER BY rectime ASC ");
           ...
           $query->execute();
            ...
            <tr>
               ...
               <td><strong>
				   <?php echo strtoupper( $row->deadline) ?> </strong>
				</td>
				 	<td><strong>
				   <?php echo strtoupper( $row->grade) ?> </strong>
				</td>
               	<td><strong>
				...
				<td>
				<a href="viewnote.php?id=<?php echo $row->questid?>&typ=<?php echo $row->type?>" type="button"  class="btn btn-success" >View Question</a>
				    
				</td>
				 <td>
				<a href="submission.php?qid=<?php echo $row->questid?>" type="button"  class="btn btn-primary" >View Submission</a>
				    
				</td>
                <td>
				<a href="changedd.php?qid=<?php echo $row->questid?>&tid=<?php echo $row->topicid?>" type="button"  class="btn btn-warning" >Change Deadline</a>
				    
				</td>
				<td>
				<a href="deletequestion.php?id=<?php echo $row->questid?>" type="button"  class="btn btn-danger" >Delete Question</a>
