...
<body>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            <h2>Promote Class</h2>
                            <p>Use the form below to promote all the students in a class at a time </p>
						<h2>	 <?php
  ...
  ?></h2>
                        ...
                        <br>
						<div class="row">
						<form method="POST" action="promoteall.php" class="form-element-area" id="fupload" enctype="multipart/form-data">
							...
							<div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <select type="text" required="yes" class="form-control" name="pclass" >
...
?>
							...
							<div class="col-lg-12 col-md-4 col-sm-4 col-xs-12">
								...
								<div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                       <input type="submit" class="form-control" name="promotion" value="Promote All Students in Class"/> 
                                    </div>
                                </div>
                            </div>
