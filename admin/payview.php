...
<head>
  ...
  <script>
    function viewrecord() {
      var str = '';
      var val = document.getElementById('classid');
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
          ...
          <div class="form-group ic-cmp-int">
            ...
            <div class="nk-int-st">
              <select type="text" required="yes" class="form-control" id="classid">
                <?php

                $sql = 'SELECT * FROM `lhpclass` ';
                $result = mysqli_query($con, $sql);
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="form-group ic-cmp-int">
            ...
            <div class="nk-int-st">
              <button type="submit" class="form-control" id="viewclass" class="btn btn-success" onclick="viewrecord()"> <strong>View Class Payment Breakdown</strong></button>
            </div>
          </div>
        </div>
