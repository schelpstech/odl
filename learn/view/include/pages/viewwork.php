<?php
    $count = 1;
    if (!empty($list_work)) {
        foreach ($list_work as $list_task) {
            ...
            <div class="col-md-3">
                <div class="white_card position-relative mb_20 ">
                    <div class="card-body">
                        ...
                        <div class="row my-4">
                            <div class="col">
                              <strong><span>Submitted  :</strong><br> <?php echo $list_task['rectime'] ?></span>  
                            </div>
                            <div class="col">
                            <strong><span>Grade  :</strong> <br><?php echo $list_task['deadline'] ?></span> 
                            </div>
                            <div class="col">
                            <strong><span>Score  : </strong><br><?php echo $list_task['score'] ?> marks</span> 
                            </div>
    ...
    <?php
        ...
        <div class="white_card position-relative mb_20 ">
            ...
            <i class="fas fa-ban " style="font-size:108px; color:red; text-align: center;"></i>
                <div class="row my-4">
                   <div class="col-auto">
                        <h4 class="text-dark mt-0">You are yet to submit any assignment for this subject </h4>
                    </div>
                </div>
            </div>
        </div>
