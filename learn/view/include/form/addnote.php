                    ...
                    <div class="white_card card_height_100 mb_30">
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Add e-Note to a topic in scheme of work for <?php echo $active_term['term'] ?></h3>
                                </div>
                            </div>
                        </div>
                        <div class="white_card_body">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select" tabindex="2" id="subject" onchange="fetchnote()" required="yes">
                                </select>
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-text">
                            ...
                            <button tabindex="5" class="btn_1 full_width text-center" onclick="add_enote()">Add e-Note To Selected Topic</button>
