                        ...
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Modify Course Outline for <?php echo $active_term['term'] ?></h3>
                                </div>
                            </div>
                        </div>
                        <div class="white_card_body">
                            <div class="input-group mb-3">
                                <div class="input-group-text">
                                    <label class="" for="classid"> Programme of Study</label>
                                </div>
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-text">
                                    <label class="" for="subject"> Course </label>
                                </div>
                            ...
                            <button tabindex="5" class="btn_4 full_width text-center" onclick="modify_topic_in_scheme()">Modify Topic in Course Outline</button>
